      ...
      body: Obx(
        ...
        Padding(
          ...
          child: Row(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [Text("Don’t have an account ? ",style: TxtStyle.small.copyWith(fontWeight: FontWeight.w500),),Text("SIGN UP",style: TxtStyle.caption.copyWith(color: AppColor.kPrimary),)],)
